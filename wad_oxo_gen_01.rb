...
module OXO_Game
	...
	class Game
		...
		def displaymatrixweb(matrix)
	 	 "<h1>Table key:<br>|#{matrix[0]}|#{matrix[1]}|#{matrix[2]}|<br>|#{matrix[3]}|#{matrix[4]}|#{matrix[5]}|<br>|#{matrix[6]}|#{matrix[7]}|#{matrix[8]}|<br></h1>"
		end


		def displaykeyweb(matrix)
	 	 "<h1>Table status:<br>|#{matrix[0]}|#{matrix[1]}|#{matrix[2]}|<br>|#{matrix[3]}|#{matrix[4]}|#{matrix[5]}|<br>|#{matrix[6]}|#{matrix[7]}|#{matrix[8]}|<br></h1>"
		end

		def setmatrixvalueweb(i, v)
			$matrix[i] = v
 	 	end 

 	 	def getmatrixvalueweb(value)
			if $matrix[value] == "_"
				$y = 1
			else 
				$y = 2
